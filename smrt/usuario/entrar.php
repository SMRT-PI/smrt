    ...
    <div class="container-fluid text-center">
        <div class="row justify-content-center">
            <form id="logar" class="col-lg-6" method="post" action="logar.php" name="logar"><br>
                ...
                <input class="form-control py-3" id="email_login" type="email" name="email" placeholder="E-mail">
                <input class="form-control py-3 mt-3 mb-4" id="senha_login" type="password" name="senha" placeholder="Senha">
            ...
            <form id="validate_form" class="col-lg-6"><br>
                ...
                <input class="form-control py-3" type="text" name="nome" id="first_name" placeholder="Nome" required data-parsley-pattern="^[a-zA-Z]+$" data-parsley-trigger="keyup">
                <input class="form-control py-3 my-3" type="text" name="sobrenome" id="last_name" placeholder="Sobrenome" required data-parsley-pattern="^[a-zA-Z ]+$" data-parsley-trigger="keyup">
                <input class="form-control py-3" type="text" name="email" id="email" placeholder="Email" required data-parsley-type="email" data-parsley-trigger="keyup">
                <input class="form-control py-3 my-3" type="password" name="senha" id="password" placeholder="Senha" required data-parsley-length="[8, 16]" data-parsley-trigger="keyup">
                <input class="form-control py-3 mb-3" type="password" name="confirm_senha" id="confirm_password" placeholder="Confirme a senha"data-parsley-equalto="#password" data-parsley-trigger="keyup" required>
                <div class="btn-group w-100 justify-content-center">
