...
if (array_search($extensao, $_UP['extensoes']) === FALSE) {
    echo "                              <META HTTP-EQUIV=REFRESH CONTENT = '0;URL=http://localhost/smrt/informacao/form_inserir.php'>
...
//    }
    ...
    if (move_uploaded_file($_FILES['imagem']['tmp_name'], $_UP['pasta'] . $nome_final)) {
        ...
        mysqli_query($conexao, "insert into area_info (titulo,descricao,conteudo,capa,dataa) values ('$titulo','$descricao','$conteudo', '$nome_final','$date')");
        echo "<META HTTP-EQUIV=REFRESH CONTENT = '0;URL=http://localhost/smrt/informacao/area_info.php'>";
    } else {
        //Upload não efetuado com sucesso, exibe a mensagem
        echo "<META HTTP-EQUIV=REFRESH CONTENT = '0;URL=http://localhost/smrt/informacao/inserir.php'>
                <script type=\"text/javascript\">
